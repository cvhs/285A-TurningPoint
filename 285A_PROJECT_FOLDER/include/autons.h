...
//AUTON UTILITY FUNCTIONS
  void motors(int degrees, int power) {
    ...
    LF.rotateFor(degrees, vex::rotationUnits::deg, power,
                 vex::velocityUnits::pct, false);
    LB.rotateFor(degrees, vex::rotationUnits::deg, power,
                 vex::velocityUnits::pct, false);
    RF.rotateFor(degrees, vex::rotationUnits::deg, power,
                 vex::velocityUnits::pct, false);
    RB.rotateFor(degrees, vex::rotationUnits::deg, power,
...
//AUTONOMOUS
  ...
  void redFront() {
    ...
    motors(60, 20);
    indexer.rotateFor(470, vex::rotationUnits::deg, 100,
                      vex::velocityUnits::pct);
    motors(665, 30);
    indexer.rotateFor(600, vex::rotationUnits::deg, 100,
                      vex::velocityUnits::pct);
    // motors(530, 60);
    intake.stop();
    turnCW(-35, 50);
  ...
  void blueFront() {
    ...
    vex::task::sleep(500);
    motors(170, 30);
    indexer.rotateFor(560, vex::rotationUnits::deg, 100,
                      vex::velocityUnits::pct);
    ...
    turnCW(46, 50);
    motors(530, 60);
    RF.rotateFor(140, vex::rotationUnits::deg, 70, vex::velocityUnits::pct,
                 false);
